...
//	IResult addParentNode(ISubjectProxy proxy, String contextLocator, String smallIcon, String locator, String subject);
	 ...
	 * @return
	 */
	IResult addSuperClass(ISubjectProxy node, String superClassLocator);
	 ...
	 * @return
	 */
	IResult setNodeType(ISubjectProxy node, String typeLocator);
	...
	IAddressableInformationResource newAIR(String locator, String subject, String body, String language,
	  ...
	  /**
	   * Return a new {@link ISubjectProxy} with the given <code>locator</code>
	   * @param locator
	   * @param label
	   * @param description
	   * @param lang
	   ...
	   * @return
	   */
	  ISubjectProxy newNode(String locator,String label, String description, String lang, 
			  String userId, String smallImagePath, String largeImagePath, boolean isPrivate);
	  
	  /**
	   * Return a new {@link ISubjectProxy} with a database-created <code>locator</code>
	   * @param label
	   * @param description
	   * @param lang
	   * @param userId
	   ...
	   * @return
	   */
	  ISubjectProxy newNode(String label, String description, String lang, String userId, 
			  String smallImagePath, String largeImagePath, boolean isPrivate);
	  
	  /**
	   * Return a new {@link ISubjectProxy} with the given <code>locator</code> and
	   ...
	   * @return
	   */
	  ISubjectProxy newSubclassNode(String locator,String superclassLocator,String label, 
			  String description, String lang, String userId, String smallImagePath, 
			  String largeImagePath, boolean isPrivate);
	  
	  /**
	   * Return a new {@link ISubjectProxy} with the database-fabricated <code>locator</code>
	   ...
	   * @return
	   */
	  ISubjectProxy newSubclassNode(String superclassLocator,String label, String description, 
	   ...
	   * @return
	   */
	  ISubjectProxy newInstanceNode(String locator,String typeLocator,String label, String description, 
			  String lang, String userId, String smallImagePath, String largeImagePath, boolean isPrivate);
	   ...
	   * @return
	   */
	  ISubjectProxy newInstanceNode(String typeLocator,String label, String description, String lang, 
			  String userId, String smallImagePath, String largeImagePath, boolean isPrivate);
...
//			  String oldLabel, String oldDetails, String userId, boolean isLanguageAddition, ITicket  credentials);
	   ...
	   * @return
	   */
	  IResult changePropertyValue(ISubjectProxy node, String key, String newValue);  
...
//	  IResult addPropertyValueInList(ISubjectProxy node, String key, String newValue);
	   ...
	   * <em>transcluded</code> {@link ISubjectProxy} when <code>isTransclude</code> is <code>true</code></p>
...
//			  String userId, String smallImagePath, String largeImagePath, boolean isTransclude, boolean isPrivate);
	   ...
	   */
	  IResult relateExistingNodes(ISubjectProxy sourceNode, ISubjectProxy targetNode, String relationTypeLocator, 
			  String userId, String smallImagePath, String largeImagePath, boolean isTransclude, boolean isPrivate);
...
//			  String userId, String smallImagePath, String largeImagePath, boolean isTransclude, boolean isPrivate);
	   ...
	   * @return
	   */
	  IResult relateExistingNodesAsPivots(ISubjectProxy sourceNode, ISubjectProxy targetNode, String relationTypeLocator, 
	  			String userId, String smallImagePath, String largeImagePath, boolean isTransclude, boolean isPrivate);
